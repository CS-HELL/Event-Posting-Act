                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <form id="updateform">
                                ...
                                <br>
                                <button type="button" id="validate" class="posteventbtn" data-toggle="modal" data-target="#exampleModalCenter">Update</button>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" style="font-family: Verdana, Arial, Helvetica, sans-serif;">
                                                <h3 style="color: black;">Are you sure you want to update this event?</h3>
                                                ...
                                                <br>
                                                <p>NOTICE: When you successfully update the event, you will be redirected to the event details page.</p>
                                                <br>
...
<script type="text/javascript" language="javascript" src="js/updateposteventscript.js"></script>
