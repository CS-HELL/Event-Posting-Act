...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 21, 2021 at 05:02 AM
...
(43, 'root', 27, '2021-12-20 22:57:06'),
(44, 'root', 54, '2021-12-20 23:00:57');
...
CREATE TABLE IF NOT EXISTS `event_posts` (
  ...
  `event_status` enum('live','cancelled') NOT NULL,
...
INSERT INTO `user_posts` (`post_id`, `post_author_uid`, `post_datetime`, `post_title`, `post_content`) VALUES
(1, 1, '', 'Reburn', '\"I thought I were no more than a bystander till I felt a touch so real\" - Mei (Nagazora, 2014). \"I will no longer be a transient when I see smiles with tears\" - Bronya (St. Freya, 2016). \"If I have never known the sore of farewell and pain of sacrifice\" - Kiana (Schiksal HQ, 2016 - Nagazora, 2017). Edit: Until now have I noticed how it came full circle to the very place the story started.'),
(2, 2, 'Jun 25, 2021 at 3:50 pm', 'Testing', 'Your time is limited, so don\'t waste it living someone else\'s life. Don\'t be trapped by dogma - which is living with the results of other people\'s thinking.\" \n\n- Steve Jobs'),
(3, 1, 'Jul 25, 2021 at 3:50 pm', 'Testing', '\"The whole secret of a successful life is to find out what is one\'s destiny to do, and then do it.\"\n\n- Henry Ford'),
(4, 4, 'Jun 25, 2021 at 3:50 pm', '17701*', '$name = $_FILES[\'file\'][\'name\'];\r\n$target_dir = \"upload/\";\r\n$target_file = $target_dir . basename($_FILES[\"file\"][\"name\"]);'),
(5, 4, 'Jun 25, 2021 at 3:50 pm', '17701*', '\"The world isn\'t perfect. But it\'s there for us, doing the best it can....that\'s what makes it so damn beautiful.\"\r\n- Roy Mustang (Full Metal Alchemist)'),
(6, 4, 'Jun 25, 2021 at 3:50 pm', 'NOTHING ', '\"We are all like fireworks: we climb, we shine and always go our separate ways and become further apart. But even when that time comes, let\'s not disappear like a firework and continue to shine.. forever.\"');
COMMIT;
